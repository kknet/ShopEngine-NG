...
if ($_GET["sort"]) {
    ...
    if($page - 2 > 0) $page2left = '<span><a class="pstr_prev" href="'.$main_page.'page='.($page - 2).'&sort='.$sorting.'">'.($page-2).'</a></span>';
    if($page - 1 > 0) $page1left = '<span><a class="pstr_prev" href="'.$main_page.'page='.($page - 1).'&sort='.$sorting.'">'.($page-1).'</a></span>';
    ...
    if($page - 2 > 0) $page2left = '<span><a class="pstr_prev" href="'.$main_page.'page='.($page - 2).'">'.($page-2).'</a></span>';
    if($page - 1 > 0) $page1left = '<span><a class="pstr_prev" href="'.$main_page.'page='.($page - 1).'">'.($page-1).'</a></span>';
    ...
    if($page + 2 <= $total) $page2right = '<span><a class="pstr_prev" href="'.$main_page.'page='.($page + 2).'">'.($page+2).'</a></span>';
    if($page + 1 <= $total) $page1right = '<span><a class="pstr_prev" href="'.$main_page.'page='.($page + 1).'">'.($page+1).'</a></span>';
