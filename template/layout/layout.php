...
<!--    <meta property="og:type" content="website">
    <meta property="og:title" content="Для красивой улыбки">
    <meta property="og:image" content="/style/assets/logo.png">
    <meta property="og:image:secure_url" content="/style/assets/logo.png">
    <meta property="og:url" content="https://poterpite.ru/collections/people">
    <meta property="og:site_name" content="Потерпите, пожалуйста!">
    <meta name="twitter:site" content="@poterpite">
...
<div style="padding: 11px;">
  <img src="//cdn.shopify.com/s/files/1/1339/0281/t/2/assets/poterpite-logo-mobile.png?5064969264160184020" alt="Потерпите" style="
    float: left;
    margin-right: 10px;
    width: 60px;
">
...
">+7 (495) 740 66 09</p>
      ...
      <form action="/search" method="get" class="drawer__search" role="search">
        ...
        <input type="search" name="q" placeholder="placeholder" aria-label="" class="drawer__search-input">

        <button type="submit" class="text-link drawer__search-submit">
          <span class="icon__fallback-text">span</span>
        </button>
      </form>
            <li class="drawer__nav-item">
              <div class="drawer__nav-has-sublist">
                <a href="" class="drawer__nav-link" id="DrawerLabel-">Link</a>
                <div class="drawer__nav-toggle">
                  <button type="button" data-aria-controls="DrawerLinklist-" class="text-link drawer__nav-toggle-btn drawer__meganav-toggle">
                    <span class="drawer__nav-toggle--open">
                      <span class="icon__fallback-text">Sub</span>
                    </span>
            ...
            <li class="drawer__nav-item">
              <a href="" class="drawer__nav-link"></a>
            </li>
            <li class="drawer__nav-item">
            ...
            <div id="SiteNavSearchCart">
              <form action="/search" method="get" class="site-header__search small--hide" role="search">
                ...
                <div class="site-header__search-inner">
                  <label for="SiteNavSearch" class="visually-hidden"></label>
                  <input type="search" name="q" id="SiteNavSearch" placeholder="" class="site-header__search-input">
                </div>
                ...
                <div class="grid__item" id="SiteNavParent">
                  ...
                  <ul class="site-nav list--inline" id="SiteNav">
                        <li class="" aria-haspopup="true">
                          <a href="" class="site-nav__link site-nav__meganav-toggle" id="SiteNavLabel-" data-aria-controls="SiteNavLinklist-{{ child_list_handle }}">{{ link.title }}
                          </a>

                          <div class="site-nav__dropdown meganav" id="SiteNavLinklist-" aria-labelledby="SiteNavLabel-" role="navigation">
...
<script>(function(){var w=window;var ic=w.Intercom;if(typeof ic==="function"){ic('reattach_activator');ic('update',intercomSettings);}else{var d=document;var i=function(){i.c(arguments)};i.q=[];i.c=function(args){i.q.push(args)};w.Intercom=i;function l(){var s=d.createElement('script');s.type='text/javascript';s.async=true;s.src='https://widget.intercom.io/widget/qof3uomo';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);}if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})()</script>
...
<script>
  $(document).ready(function() {
	...
	{{ 'einstein.js' | asset_url | script_tag }}
  {% if template contains 'customers/account' %}
  	{{ 'payments_link.js' | asset_url | script_tag }}
  {% endif %}
</body>
</html>
