...
<!--    <div id="AddressNewForm" class="hide content-block content-block--large form-vertical">
      <form method="post" action="/user/addresses" id="address_form_new" accept-charset="UTF-8"><input type="hidden" value="customer_address" name="form_type"><input type="hidden" name="utf8" value="✓">
        ...
        <div class="grid">
          ...
          <div class="grid__item medium-up--one-half">
            ...
            <input type="text" id="AddressFirstNameNew" name="address[first_name]" value="">
          </div>

          <div class="grid__item medium-up--one-half">
            <label for="AddressLastNameNew">Фамилия</label>
            <input type="text" id="AddressLastNameNew" name="address[last_name]" value="">
          </div>
        ...
        <div class="grid">
          ...
          <div class="grid__item">
            ...
            <input type="text" id="AddressAddress1New" name="address[address1]" value="">

            <label for="AddressAddress2New">Дополнительная информация</label>
            <input type="text" id="AddressAddress2New" name="address[address2]" value="">
          </div>
        ...
        <p><input type="submit" class="btn" value="Добавить Адрес"></p>
        <p class="text-center"><button type="button" class="text-link link-accent-color address-new-toggle">Отмена</button></p>
      ...
      <h2>Ваши Адреса</h2>
        ...
        <?php } ?>
            ...
            <p>
              ...
              <button type="button" class="text-link link-accent-color address-delete" data-form-id="5739200643" data-confirm-message="Вы уверены, что хотите удалить этот адрес?">Удалить</button>
            </p>
...
<!--        <div id="EditAddress_5739200643" class="hide form-vertical">
  ...
  <div class="grid__item medium-up--one-third">
    <div class="content-block text-center">
      <p><button type="button" class="btn address-new-toggle">Добавьте Новый Адрес</button></p>
    </div>
  </div>
</div>
