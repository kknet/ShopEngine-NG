...
<div style='margin: 0 80px;'>
	...
	<table style='width: 100%;'>
		<tr>
			<td style='border: 2px solid #000; width: 30%;'>ИНН 7714404509</td>
			<td style='border: 2px solid #000; width: 30%;'>КПП 771401001</td>
			<td rowspan="2" style='border: 2px solid #000; width: 10%; vertical-align: bottom; text-align: center;'>Сч. №</td>
			<td rowspan="2" style='border: 2px solid #000; vertical-align: bottom;'>40702810000000210120</td>
		</tr>
		<tr>
			<td colspan="2" style='border: 2px solid #000;'>Получатель<br>ООО «ПОТЕРПИТЕ»</td>
		</tr>
		<tr>
	...
	<h1 style='text-align: center; margin-top: 25px; margin-bottom: 0; font-size: 18px;'>ООО «ПОТЕРПИТЕ»</h1>
	...
	<table style="margin-top: 15px; width: 100%;">
		<tr>
			...
			<td>
				<img src="lib/views/img/venzel_poterpite.png" alt="подпись" width='150px'>
			</td>
		...
		<tr>
			<td colspan="3" style="text-align: left;">
				<img src="lib/views/img/shtempel_poterpite.png" alt="печать компании" width='150px'>
			</td>
		</tr>
		<tr>
			<td colsapn="3">
